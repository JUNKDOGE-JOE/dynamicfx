...
prefix='(function(){if(!app.project.file||app.project.file.parent.name!=="engineering-20260920")throw Error("Wrong fixture");var l=app.project.itemByID(174).layer(1),f=l.property("ADBE Effect Parade");'
