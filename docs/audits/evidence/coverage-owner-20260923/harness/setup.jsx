...
app.project.save(new File("<workspace>/scripts/out/coverage-owner-20260923/production-coverage.aep"));return JSON.stringify({records:records,found:found,version:app.version});
})()