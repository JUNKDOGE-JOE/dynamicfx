...
var f=new File("<REPO>/scripts/out/010/ae2026/010c-ui-fresh-before.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();