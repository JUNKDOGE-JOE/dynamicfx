...
fn properties() -> Vec<Property> {
    vec![
        ...
        Property::AE_Effect_Version {
            version: 0, subversion: 0, bugversion: 26, stage: Stage::Develop, build: 0,
        },
        Property::AE_Effect_Info_Flags(0),
        Property::AE_Effect_Global_OutFlags(OutFlags::DeepColorAware | OutFlags::SendUpdateParamsUI | OutFlags::WideTimeInput),
