...
var om=i.outputModule(1);om.applyTemplate("Photoshop");om.file=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/aerender.psd");
app.project.save(new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/native-aerender.aep"));
...
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/queue.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();