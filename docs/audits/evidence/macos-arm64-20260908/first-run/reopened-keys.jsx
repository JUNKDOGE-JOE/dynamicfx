...
var c=comp("DFX_param");var p=prop(fx(c),"Gain");return {keys:p.numKeys,t0:sample(c,160,120,0,0),t1:sample(c,160,120,1,0)};
})();var res={ok:true,data:data};}catch(e){var res={ok:false,error:String(e),line:e.line};}
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/reopened-keys.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();