...
app.purge(PurgeTarget.ALL_CACHES);var r={states:states(),depths:[]};
...
comp("DFX_gradient").saveFrameToPng(0,new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026"+"/"+"reopened-capture"+"_gradient.png"));
comp("DFX_multi").saveFrameToPng(0,new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026"+"/"+"reopened-capture"+"_multi.png"));
app.project.save(new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026"+"/native-smoke.aep"));return r;

})();var res={ok:true,data:data};}catch(e){var res={ok:false,error:String(e),line:e.line};}
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/reopened-capture.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();