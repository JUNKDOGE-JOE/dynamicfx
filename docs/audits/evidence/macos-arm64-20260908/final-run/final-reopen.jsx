...
app.project.close(CloseOptions.DO_NOT_SAVE_CHANGES);app.open(new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/native-smoke.aep"));return states();
})();var res={ok:true,data:data};}catch(e){var res={ok:false,error:String(e),line:e.line};}
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/final-reopen.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();