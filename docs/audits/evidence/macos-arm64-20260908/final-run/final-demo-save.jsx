...
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/final-demo-save.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();