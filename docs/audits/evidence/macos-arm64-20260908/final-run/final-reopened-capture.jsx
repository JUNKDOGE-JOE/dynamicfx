...
comp("DFX_gradient").saveFrameToPng(0,new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026"+"/"+"final-reopened-capture"+"_gradient.png"));
comp("DFX_multi").saveFrameToPng(0,new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026"+"/"+"final-reopened-capture"+"_multi.png"));
...
var f=new File("/Users/junk_doge/Documents/DynamicFX/scripts/out/macos/ae2026/final-reopened-capture.json");f.encoding='UTF-8';if(!f.open('w'))throw Error(f.error);f.write(encode(res));f.close();return encode(res);})();