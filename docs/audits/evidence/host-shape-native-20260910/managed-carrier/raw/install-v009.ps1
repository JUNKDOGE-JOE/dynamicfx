...
$probeSource = Join-Path $PSScriptRoot 'DynamicFxHostShapeProbe-v009.aex'
...
$oldHash = '90248EEBDA86D958C782D4ACD51E4E806BAE76FC2E06DAB8454DD537E7685834'
$newHash = 'F0BD26C4ADBC52CD56ABE2D3495393C8B3A5E9214D1F996277C58E352E7BB456'
...
$backup = Join-Path $PSScriptRoot 'installed-probe-v008.aex'
...
$record | ConvertTo-Json | Set-Content -LiteralPath (Join-Path $PSScriptRoot 'install-v009.json') -Encoding utf8
