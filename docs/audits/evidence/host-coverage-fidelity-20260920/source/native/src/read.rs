    ...
    effect: sys::AEGP_EffectRefH, mode: i32, time: ae::Time) -> Result<String>
{
    match mode {
        ...
        3..=9 => coverage_for_effect(input, id, layer, effect, mode, time.into()),
        _ => Err("background mode must be 2 through 9; PF paths use rendering".into()),
    }
}
