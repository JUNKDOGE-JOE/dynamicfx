...
| Interrupted preview leaves no cached frame missing a layer | `NOT_RUN` | `NOT_RUN` | `NOT_RUN` | [`FAIL`](#tr-cache-001--interrupted-render-poisons-the-frame-cache-field-defect) (field, 0.0.4) | `NOT_RUN` |
...
- Status: `FAIL` — observed in the field on the 0.0.4 artifact, AE 2026 (26.3x87), 2026-08-21, and reproduced by a scripted harness the same day. The fix is unscheduled. Public issue [#7](https://github.com/JUNKDOGE-JOE/dynamicfx/issues/7).
- Date: 2026-08-21
