...
| Copied instance keeps its own slot mapping (same source, different BindingPlan) | `NOT_RUN` | `NOT_RUN` | [`FAIL`](#tr-bind-002--copied-instance-corrupts-slot-mapping-field-defect) (field, 0.0.4) | `NOT_RUN` | `NOT_RUN` |
