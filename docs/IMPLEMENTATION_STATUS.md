...
| Field | Value |
|---|---|
| Status date | 2026-08-21 (TR-BIND-002/#6 **fixed**: ADR-0038 Accepted and implemented; fix build `ff1197d9…` installed on AE 2025 + 2026; the TR-BIND-002 harness is `PASS` on **both** years after the recorded pre-fix `FAIL`, and the full M2/M3 batteries are `PASS` on both years (TR-0038-001). Committed locally, not pushed. TR-CACHE-001/#7 fixed at `cfccd5d`, host-verified PASS) |
...
| Released | **0.0.4 public pre-release, 2026-08-19** (TR-REL-004: ADR-0037 pool valid-range fix — float>1 / negatives / int>10 reach the shader unclamped; verified AE 2025 + 2026) — previously **0.0.3, 2026-08-15** (layer/gradient/Point 3D/path params), **0.0.2, 2026-08-14**, **0.0.1, 2026-08-14** — [github.com/JUNKDOGE-JOE/dynamicfx](https://github.com/JUNKDOGE-JOE/dynamicfx) (curated public repo, MIT), Releases v0.0.1…v0.0.4 (`DynamicFX-0.0.4-win-x64.zip`, TR-REL-004); the development record moved into this repository on 2026-08-17 per [ADR-0036](adr/0036-single-repository-record.md) |
