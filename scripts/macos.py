...
def verify(bundle):
    ...
    require(any(line.endswith(" _EffectMain") for line in symbols), "EffectMain is not exported")
    ...
    require(pstring(props[b"ma64"]) == "EffectMain", "Missing ARM64 PiPL entry point")
